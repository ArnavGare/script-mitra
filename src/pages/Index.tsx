    ...
    <>
      ...
      <div className={`min-h-screen transition-all duration-500 ${isDarkMode ? 'dark' : ''}`}>
        ...
        <div className="relative z-10">
          ...
          <section id="home" className="scroll-mt-20">
            <div className="text-center pt-12 pb-7 px-4">
              <div className="animate-fade-in">
                ...
                <div className="flex flex-wrap justify-center gap-4 mt-7 animate-fade-in-up">
                  {[
                    { name: "Script Mitra", desc: "AI Video Script Generator", color: "from-[#0ea5e9] to-[#6366f1]", url: "/", icon: "📝" },
                    { name: "Hashtag Mitra", desc: "Hashtag Research & Trends", color: "from-[#14dfaa] to-[#12b8ff]", url: "/hashtags-mitra", icon: "🏷️" },
                    { name: "Store", desc: "Ready-Made Creator Resources", color: "from-[#eab308] to-[#a855f7]", url: "/store", icon: "🛒" }
                  ].map((product, idx) => (
                    <a
                      key={product.name}
                      href={product.url}
          ...
          {/* ---------- End Automation Mitra Hero Section ---------- */}
...
// NOTE: src/pages/Index.tsx is now even longer with the rebrand and should be broken into components for maintainability.
