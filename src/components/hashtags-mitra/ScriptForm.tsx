...
export default function ScriptForm({
  ...
  return <form onSubmit={handleGenerate} className="w-full flex flex-col gap-7">
      ...
      <Button size="lg" type="submit" disabled={isLoading} className="group w-full font-display bg-gradient-cyan-purple shadow-smooth text-white hover:scale-[1.03] hover:shadow-lg transition-all duration-200 ring-1 ring-blue-200/20 dark:ring-blue-900/40 font-medium text-left text-2xl mx-0 my-0 -bottom-1/3 py-[26px] rounded-2xl">
